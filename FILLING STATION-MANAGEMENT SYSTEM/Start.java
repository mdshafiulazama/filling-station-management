...
public class Start
{
	public static void main(String args[])
	{
		...
		FillingStation b = new FillingStation();
		TransactionDetails td = new TransactionDetails();
		
		
		System.out.println("-------------------------------------------");
		System.out.println("WelCome to HAQUE FILLING STATION");
		System.out.println("-------------------------------------------");
				...
				case 1:
					...
					switch(option1)
					{
						...
						case 3: 
							...
							if(e3 != null)
							{
								td.writeInFile(e3.getEmpId() + " EMPLOYEE " + e3 + " from TRANNO number " + e3.getEmpId());
				...
				case 2:
					...
					switch(option2)
					{
						case 1:
							...
							{
								System.out.println("Customer " + c1.getTranNo() + " has been Inserted");
								if(c1 != null)
							{
								System.out.println("### Valid Customer ###");
								td.writeInFile("FROM CUSTOMER TRANSACTION NUMBER:"+c1.getTranNo() + " OIL HAS BEEN SOLD");
						...
						case 2:
							...
							if(c2 != null)
							{
								...
								{
									System.out.println("Customer " + c2.getTranNo() + " has been Removed");
								}
							}
							else
							{
